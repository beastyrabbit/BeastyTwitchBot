...
if CLIENT_ID is None or CLIENT_SECRET is None:
	raise ValueError(
		"Please set the TWITCH_CLIENT_ID and TWITCH_CLIENT_SECRET environment variables"
	)
...
def get_authorization_code():
	"""Open a browser to authorize and get the code."""
	auth_url = (
		f"https://id.twitch.tv/oauth2/authorize"
		f"?client_id={CLIENT_ID}&redirect_uri={REDIRECT_URI}&response_type=code&scope={SCOPES.replace(' ', '+')}"
	)
